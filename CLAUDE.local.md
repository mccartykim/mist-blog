...
**YOU ARE IN: `mist_blog/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/mist_blog/` (rig root) or other directories
...
**Your mail address:** `mist_blog/polecats/chrome`
**Your rig:** mist_blog
**Your Witness:** `mist_blog/witness`
...
| Ask Witness for help | `gt mail send mist_blog/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`mist_blog/witness`) when:
...
```bash
gt mail send mist_blog/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
